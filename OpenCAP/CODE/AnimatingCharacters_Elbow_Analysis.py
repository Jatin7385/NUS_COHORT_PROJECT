...
markerData1 = readMarkerData("C:/Users/Jatin/Desktop/Engineering/ROBOTICS PROGRAM NUS/PROJECT/OpenCAP/DATA/NUS_PROJECT_DATA/MarkerData/Elbow_Final.trc")
...
for i in range(int(n)):
    ...
    patch1 = mpatches.Patch(color='blue', label='Physio Session 1')
    patch2 = mpatches.Patch(color='red', label='Physio session 2')
